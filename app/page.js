    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <section className="w-full px-5 py-20 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col rounded-2xl border border-gray-200 p-6 gap-4">
              ...
              <ul className="flex flex-col gap-2 text-sm text-gray-600 flex-1">
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>1 active listing</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>No application cap</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Basic profile</li>
              </ul>
            ...
            <div className="flex flex-col rounded-2xl border border-gray-200 p-6 gap-4">
              ...
              <ul className="flex flex-col gap-2 text-sm text-gray-600 flex-1">
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>3 active listings</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Applicant messaging</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Priority placement</li>
              </ul>
              <a href="#waitlist" className="text-center text-sm font-medium border border-gray-200 rounded-xl py-2.5 hover:bg-gray-50 transition">
                Get started
              </a>
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black p-6 gap-4 relative">
              ...
              <ul className="flex flex-col gap-2 text-sm text-gray-600 flex-1">
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Unlimited listings</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Featured placement</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Analytics dashboard</li>
              </ul>
              <a href="#waitlist" className="text-center text-sm font-semibold bg-black text-white rounded-xl py-2.5 hover:bg-gray-800 transition">
                Get started
              </a>
            </div>
            ...
            <div className="flex flex-col rounded-2xl border border-gray-200 p-6 gap-4">
              ...
              <ul className="flex flex-col gap-2 text-sm text-gray-600 flex-1">
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Multiple locations</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Dedicated support</li>
                <li className="flex items-start gap-2"><span className="text-green-500 mt-0.5">✓</span>Bulk hiring tools</li>
              </ul>
              <a href="#waitlist" className="text-center text-sm font-medium border border-gray-200 rounded-xl py-2.5 hover:bg-gray-50 transition">
                Get started
              </a>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            All paid jobs include SafePay — secure payments with a 5% processing fee baked in. Teens always receive the full agreed amount.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              ...
              <p className="text-sm text-gray-500">For $5 you can pin your listing to the top of search results for 48 hours — great when you need someone fast and do not want to wait.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-5 py-24 bg-black">
        <div className="max-w-xl mx-auto flex flex-col items-center text-center gap-6">
          ...
          <a href="#waitlist" className="bg-white text-black font-semibold text-sm px-8 py-3 rounded-full hover:bg-gray-100 transition">
            Get early access
          </a>
        </div>
      </section>
      ...
      <footer className="w-full px-5 py-10 bg-black border-t border-white/10">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Twitter/X */}
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition flex items-center justify-center">
            ...
            {/* Instagram */}
            <a  href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
            ...
            {/* TikTok */}
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
