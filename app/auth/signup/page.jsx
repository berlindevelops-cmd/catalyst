...
export default function SignupPage() {
  ...
  async function handleEmailSignup() {
    ...
    setLoading(true);
    setError("");
    const { data, error: sbError } = await getSupabase().auth.signUp({ email, password });
    setLoading(false);
    if (sbError) { setError(sbError.message); return; }
    if (data.user) router.push("/auth/onboarding");
  }

  async function handleGoogleSignup() {
    // No pendingRole needed — everyone goes to /auth/onboarding after OAuth
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#fff", display: "flex",
      ...
      <nav style={{ width: "100%", padding: "16px 20px", display: "flex",
        alignItems: "center", justifyContent: "space-between",
        borderBottom: "1px solid #f3f4f6", boxSizing: "border-box", ...fadeUp(0) }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column",
        alignItems: "center", justifyContent: "center", padding: "64px 20px" }}>
        <div style={{ width: "100%", maxWidth: 360, display: "flex",
          ...
          <div style={{ textAlign: "center", ...fadeUp(0.05) }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: "#f3f4f6",
              ...
              marginBottom: 14 }}>
              <Zap size={26} color="#111" strokeWidth={1.75} />
            </div>
            <h1 style={{ fontSize: 24, fontWeight: 700, color: "#111", margin: 0,
              letterSpacing: "-0.4px" }}>Create your account</h1>
            <p style={{ color: "#9ca3af", marginTop: 6, fontSize: 14 }}>
              Join Catalyst — takes under a minute
            </p>
          </div>
          ...
          <div style={fadeUp(0.1)}>
            <button
              ...
              style={{ width: "100%", display: "flex", alignItems: "center",
                justifyContent: "center", gap: 10, border: "1.5px solid #e5e7eb",
                borderRadius: 14, padding: "13px 20px", fontSize: 14, fontWeight: 500,
            ...
            {[
              ...
              <div key={field.label}>
                ...
                <input type={field.type} placeholder={field.placeholder}
                  ...
                  onKeyDown={field.onKeyDown} style={inputStyle}
          ...
          <div style={fadeUp(0.25)}>
            <button
              ...
              disabled={loading}
              style={{ width: "100%", background: "#111", color: "#C8FF00",
