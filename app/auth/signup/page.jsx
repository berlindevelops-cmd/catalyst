      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "64px 20px" }}>
        <div style={{ width: "100%", maxWidth: 420, display: "flex", flexDirection: "column", alignItems: "center", gap: 32 }}>
          ...
          <div style={{ textAlign: "center", opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(12px)", transition: "opacity 0.5s ease, transform 0.5s ease" }}>
            <h1 style={{ fontSize: 30, fontWeight: 700, color: "#111", margin: 0, letterSpacing: "-0.5px" }}>
              Join Catalyst
            </h1>
                ...
                >
                  {isSelected && (
                    <span style={{
                      ...
                      animation: "shimmer 1.8s ease infinite", pointerEvents: "none",
                    }} />
                  )}
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontWeight: 600, fontSize: 15, margin: 0, color: isSelected ? "#fff" : "#111", transition: "color 0.2s ease" }}>
                      {card.label}
                    </p>
                    <p style={{ fontSize: 13, margin: "3px 0 0", color: isSelected ? "rgba(255,255,255,0.5)" : "#9ca3af", transition: "color 0.2s ease" }}>
                      {card.sub}
                    </p>
                  </div>
          ...
          <button
            ...
            style={{
              ...
              opacity: selected ? 1 : 0.3, display: "flex", alignItems: "center",
          ...
          >
            Continue
            <ArrowRight size={16} style={{ transform: selected ? "translateX(2px)" : "translateX(0)", transition: "transform 0.2s ease" }} />
          </button>
        </div>
      </div>
